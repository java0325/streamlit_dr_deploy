# keypoints 구현완료
# 10.27 이 부분만 적용으로 변경 : angles_left_leg_up, angles_right_leg_up, angles_core_decline
...
for video_id, group_data in grouped:
    ...
    # ax.text(0.02, 0.95, f"Average Speed: {mean_speed:.2f}", transform=ax.transAxes, fontsize=10, ha='center',
...
#     ax_stride.text(0.95, 0.95, f"Average: {mean_stride:.2f}", transform=ax_stride.transAxes, 
#                    ha='center', va='top',bbox=dict(facecolor='white', edgecolor='black'))                   
...
#     ax_cadence.text(0.95, 0.95, f"Average: {mean_cadence:.2f}", transform=ax_cadence.transAxes, 
#                    ha='center', va='top',bbox=dict(facecolor='white', edgecolor='black')) 
